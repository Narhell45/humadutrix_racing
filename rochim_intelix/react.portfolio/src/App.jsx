...
function App() {
  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          ...
          <p className="text-base/loose mb-6 opacity-50">
            Saya mempunyai ketertarikan dalam bidng Programing dan Desaigner, terutama pada
            pembuatan Website dan Desain seperti Poster, Pamflet, serta Banner, Ketertarikan pada
            bidang ini sudah berlangsung lebih dari 4 Tahun untuk semua Bidang.
          </p>
      ...
      {/* --- Tentang Section --- */}
        ...
        <div className="tools mt-32">
           <h1 className="text-4xl/snug font-bold mb-4" data-aos="fade-up"
            data-aos-duration="1000" data-aos-once="true">Tools yang dipakai</h1>
           <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose
           opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
           ...
           grid-cols-1 gap-4">
              ...
              <div className="flex items-center gap-2 p-3 border border-zinc-600 rounded-md
                 ...
                 data-aos-once="true">
                <img src={tool.gambar} alt="Tools Image" className="w-14 bg-zinc-500 p-1
      ...
      {/* Proyek */}
      <div className="proyek mt-23 py-10" id="proyek">
        <h1 className="text-center text-4xl font-bold mb-2" data-aos="fade-up"
        data-aos-duration="1000" data-aos-once="true">Proyek</h1>
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" 
        data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini beberapa proyek yang
         telah saya buat.
        </p>
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Mari terhubung dengan 
        GWEH.
        </p>
